...
*********************************************************************************************
* @param[input]      DWORD init - initial value for the remainder
                     BYTE *ptr  - pointer to data first byte
*                    DWORD size - size of data to calculate the checksum for
* @param[output]
* @return            DWORD      - checksum value
